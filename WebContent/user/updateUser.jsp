	...
	<tr>
		...
		<td class="ct_write01">
			<select 	name="phone1" class="ct_input_g" style="width:50px" 
				...
				<option value="010" ${ ! empty  userVO.phone && userVO.phone.split("-")[0] == "010" ? "selected" : ""  } >010</option>
				<option value="011" ${ ! empty  userVO.phone && userVO.phone.split("-")[0] == "011" ? "selected" : ""  } >011</option>
				<option value="016" ${ ! empty  userVO.phone && userVO.phone.split("-")[0] == "016" ? "selected" : ""  } >016</option>
				<option value="018" ${ ! empty  userVO.phone && userVO.phone.split("-")[0] == "018" ? "selected" : ""  } >018</option>
				<option value="019" ${ ! empty  userVO.phone && userVO.phone.split("-")[0] == "019" ? "selected" : ""  } >019</option>
			</select>
			<input type="text" name="phone2" value="${ ! empty userVO.phone.split('-')[1] ? userVO.phone.split('-')[1] : ''}" class="ct_input_g" style="width:100px; height:19px"  maxLength="9" >
			- 
			<input type="text" name="phone3" value="${ ! empty userVO.phone.split('-')[2] ? userVO.phone.split('-')[2] : ''}"
